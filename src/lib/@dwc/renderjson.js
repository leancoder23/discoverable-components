...
var module, window, define, renderjson=(function() {
    ...
    function _renderjson(json, indent, dont_indent, show_level, options) {
        ...
        if (json.constructor == Array) {
            ...
            return disclosure("[", options.collapse_array_msg(json.length), "]", "array", function () {
        ...
        return disclosure("{", options.collapse_object_msg(Object.keys(json).length), "}", "object", function () {
    ...
    renderjson.set_replacer = function(replacer) { renderjson.options.replacer = replacer;
                                                   return renderjson; };
    renderjson.set_collapse_object_msg = function(collapse_object_msg) { renderjson.options.collapse_object_msg = collapse_object_msg; return renderjson; };

    renderjson.set_collapse_array_msg = function(collapse_array_msg) { renderjson.options.collapse_array_msg = collapse_array_msg; return renderjson; };
    ...
    renderjson.set_collapse_object_msg(function(len) { return len + " attribute" + (len==1 ? "" : "s") });
    renderjson.set_collapse_array_msg(function(len) { return len + " item" + (len==1 ? "" : "s") })
    return renderjson;
})();
